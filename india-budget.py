...
fig.update_xaxes(row=1, col=1, range=[overall_min_value*0.8, overall_max_value * 1.05], fixedrange=True, showline=True, linewidth=1.5, linecolor='grey', mirror=True, showgrid=True, gridcolor='lightgrey')
